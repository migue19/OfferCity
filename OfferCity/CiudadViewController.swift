...
class CiudadViewController: UIViewController, UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    override func viewDidLoad() {
        ...
        /*let backButton = UIBarButtonItem(title: "< Hola", style: UIBarButtonItemStyle.plain, target: navigationController, action: nil)
